...
const Service = {
  ...
  async createService({
    ...
    const query = `
    INSERT INTO services (image, service_name, service_type, processing_time, price, created_at, updated_at) 
    VALUES ($1, $2, $3, $4, $5, NOW(), NOW()) 
    RETURNING *
  `;
    const values = [image, service_name, service_type, processing_time, price];
